...
function ConceptPage({concept,onChange,readonly}){
  ...
  const generateHooks=async(append)=>{
    ...
    }catch(err){console.error("generateHooks error:",err);}
    setHooksBusy(false);
  };
  return(
    <div style={{maxWidth:760,padding:"40px 24px 120px",margin:"0 auto"}}>
